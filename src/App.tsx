  ...
  return (
    <>
      ...
      <div className="relative z-10 min-h-screen flex flex-col lg:flex-row items-center justify-between max-w-7xl mx-auto px-6 lg:px-8 py-8 lg:py-6">   
        ...
        {/* Top Section - Headline and Carousel */}
        <div className="w-full flex flex-col lg:flex-row items-center justify-between gap-12 mb-12">
          ...
          <div className="flex-1 max-w-2xl text-center lg:text-left">
            ...
            {/* Tagline */}
            <p className="text-gray-600 text-lg lg:text-xl leading-relaxed max-w-lg mx-auto lg:mx-0 text-center lg:text-left">
